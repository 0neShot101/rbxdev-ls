...
export declare const serializeGameTreeNode: (node: GameTreeNode) => {
  name: string;
  className: string;
  hasChildren?: boolean;
  children?: unknown[];
...
export declare const createMcpServer: (injectedBridge?: ExecutorBridgeLike) => {
  server: McpServerLike;
  bridge: ExecutorBridgeLike;
};
