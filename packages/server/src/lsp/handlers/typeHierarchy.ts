...
/**
 * Collects all type alias declarations from the AST for type hierarchy navigation.
 * @param chunk - The parsed AST chunk to scan.
 * @returns An array of type alias info objects with name, range, and type annotation.
 */
...
/**
 * Extracts referenced type names from a type annotation to determine supertype relationships.
 * @param type - The type annotation to extract from.
